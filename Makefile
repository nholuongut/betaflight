...
###############################################################################
#
# Makefile for building the Nho Luong firmware.
#
...
## test              : run the Nho Luong test suite
## junittest         : run the Nho Luong test suite, producing Junit XML result files.
## test-representative: run a representative subset of the Nho Luong test suite (i.e. run all tests, but run each expanded test only for one target)
## test-all: run the Nho Luong test suite including all per-target expanded tests
